...
import com.hmall.cart.config.CartBusiness;
...
//        }
    ...
    private void checkCartsFull(Long userId) {
        ...
        if (count >= cartBusiness.getMaxItem()) {
            throw new BizIllegalException(StrUtil.format("用户购物车课程不能超过{}", cartBusiness.getMaxItem()));
        }
    }
