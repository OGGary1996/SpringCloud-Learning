...
import com.hmall.item.api.config.ItemClientFallbackConfig;
...
@FeignClient(name = "item-service", configuration = ItemClientFallbackConfig.class, fallbackFactory = ItemClientFallback.class)
